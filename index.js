...
function randomColor() {
  ...
  //the fade grid function 
  //If the cell has not been coloured, set it to the background color

  // attatch class to each item. this fades the color to the background color over 1.5 second
  ...
  //Let the fade out button clear the entire grid
